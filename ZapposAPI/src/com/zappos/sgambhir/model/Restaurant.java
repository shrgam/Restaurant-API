...
public class Restaurant implements Serializable {
   ...
   public Restaurant(int id, String name, int rating ,float avgPrice, boolean onlineDelivery,String number){
      this.restntId = id;
   ...
   public boolean equals(Object object){
      if(object == null){
         ...
         if(restntId == item.getId()
            && restntName.equals(item.getName())
